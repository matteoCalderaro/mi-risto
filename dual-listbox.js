    ...
    d = class {
      ...
      changeOrder(t, e) {
        ...
        let s = this.options.findIndex(
          (a) => (console.log(a, t.dataset.id), a.value === t.dataset.id)
        );
        console.log(s);
      ...
      changeSelected(t) {
        ...
        (e.selected = !e.selected),
          ...
          setTimeout(() => {
            ...
            e.selected
              ? (s.initEvent("added", !1, !0), (s.addedElement = t))
              : (s.initEvent("removed", !1, !0), (s.removedElement = t)),
        ...
        [this.availableList, this.selectedList].forEach((t) => {
          t.addEventListener(
            ...
            t.addEventListener("drop", (e) => {
              e.preventDefault(),
                e.target.classList.remove("drop-in"),
                (t.classList.contains("dual-listbox__selected") ||
                  t.classList.contains("dual-listbox__available")) &&
                  this.changeSelected(this.dragged);
            });
        });
      }
      ...
      _initializeSortButtons() {
        ...
        t.classList.add("dual-listbox__button"),
          ...
          t.addEventListener("click", (i) => this._onSortButtonClick(i, h));
        let e = document.createElement("button");
        e.classList.add("dual-listbox__button"),
          (e.innerText = this.downButtonText),
          e.addEventListener("click", (i) => this._onSortButtonClick(i, u));
      ...
      _onSortButtonClick(t, e) {
        t.preventDefault();
        let s = this.dualListbox.querySelector(".dual-listbox__item--selected"),
      ...
      _getNewIndex(t, e) {
        let s = this.options.findIndex((a) => a.value === t.dataset.id),
          i = s;
        return h === e ? (i -= 1) : u === e && s < t.length - 1 && (i += 1), i;
      }
